...
const TeamDetails: React.FC<EquipeSeasonProps> = ({
    ...
    <div className="title"> Equipe : {nomEquipe}</div>
    ...
    <div className="title"> Meilleurs Buteurs de la saison :</div>{top5Buteurs && top5Buteurs.map((buteur:any) => 
    ...
    <div className="incased">
        <div className="title">Meilleur match de la saison :</div>
    ...
    <div className="incased">
        <div className="title">Pire match de la saison : </div>
            <div>
